...
export const GlassCard: React.FC<GlassCardProps> = ({ children, className = '', title, subtitle }) => {
  return (
    <div className={`relative overflow-hidden bg-[#EDEDED]/60 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] rounded-3xl p-8 ${className}`}>
